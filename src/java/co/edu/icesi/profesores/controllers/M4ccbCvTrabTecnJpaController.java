...
public class M4ccbCvTrabTecnJpaController implements Serializable {
    ...
    public List <M4ccbCvTrabTecn> findM4ccbCvTrabTecnByStdIdHr(String idProfesor){
        EntityManager em=getEntityManager();
        try{
            TypedQuery<M4ccbCvTrabTecn> q= em.createNamedQuery("M4ccbCvTrabTecn.findByStdIdHr", M4ccbCvTrabTecn.class);
            q.setParameter("stdIdHr", idProfesor);
            List <M4ccbCvTrabTecn> items = q.getResultList();
            return items;
