...
@NamedQueries({
    ...
    @NamedQuery(name = "VrrhCursosProf.findByProfesorPeriod", query = "SELECT DISTINCT s FROM VrrhCursosProf s WHERE s.vrrhCursosProfPK.profesorCedula = :profesorCedula AND s.vrrhCursosProfPK.periodoPeriodoAcad=:periodoAcad AND s.vrrhCursosProfPK.periodoConsecutivo=:periodoConsecutivo order by 1"),
