...
@NamedQueries({
    ...
    @NamedQuery(name = "StdEmail.findByActiveStdIdPersonStdIdLocatType", query = "SELECT s FROM StdEmail s WHERE s.stdIdLocatType = :stdIdLocatType and s.stdEmailPK.stdIdPerson = :stdIdPerson and s.stdDtEnd = :stdDtEnd"),
    ...
    @NamedQuery(name = "StdEmail.findByStdIdPersonCcbPreferido", query = "SELECT s FROM StdEmail s WHERE s.ccbPreferido = :ccbPreferido and s.stdEmailPK.stdIdPerson = :stdIdPerson and s.stdDtEnd = :stdDtEnd"),
